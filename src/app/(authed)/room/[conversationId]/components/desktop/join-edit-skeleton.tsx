...
const JoinEditSkeleton = () => {
  return (
    <Box
      title=""
      className="mb-4 flex h-full min-h-0 w-full flex-1 flex-col justify-between rounded-t-md p-8 text-sm lg:mb-0"
      wrapperClassName="h-full w-[27%]"
      titleClassName="hidden"
    >
      <div className="flex h-full w-full animate-pulse flex-col gap-5 overflow-y-hidden lg:gap-8">
        <div className="flex min-h-0 w-full flex-1 flex-col gap-6 overflow-y-hidden">
          ...
          <div className="flex shrink-0 gap-6">
            <div className="flex h-[83px] w-[83px] shrink-0 items-center justify-center rounded-md bg-gray-600">
