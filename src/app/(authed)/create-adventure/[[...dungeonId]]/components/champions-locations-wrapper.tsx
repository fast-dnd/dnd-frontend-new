...
const CastleIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="61" height="60" viewBox="0 0 61 60" fill="none">
    <path d="M24.25 33.75H8L10.5 36.25H21.75L24.25 33.75Z" fill="white" fill-opacity="0.8" />
    ...
    <path
      ...
      fill-opacity="0.8"
    />
    <path d="M36.75 33.75H53L50.5 36.25H39.25L36.75 33.75Z" fill="white" fill-opacity="0.8" />
    <path
