...
import { IStatistics } from "@/types/kingdom";
import { Box } from "@/components/ui/box";

const MyAccount = ({ statistics }: { statistics: IStatistics }) => {
  return (
      ...
      <div className="flex flex-col gap-8">
        <div className="flex gap-4">
          ...
          <div className="flex flex-col gap-4">
            <p className="text-xl font-bold">roger alfred III</p>
            <p>Level 3</p>
            <Link
        ...
        <div className="grid grid-cols-2 grid-rows-4 gap-4">
          ...
          <StatisticsCard
            ...
            value={statistics.totalGameplayHours}
            name="Hours played"
          />
        </div>
      </div>
