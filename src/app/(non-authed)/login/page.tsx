...
const Login = () => {
  ...
  return (
    <div className="fixed inset-0 flex h-full items-end justify-center max-lg:px-4">
      ...
      <div className="fixed bottom-0 flex w-full flex-col items-center gap-6 from-black via-black/80 via-80% to-transparent pb-10 max-lg:bg-gradient-to-t">
        <div className="flex w-full flex-col items-center gap-6 lg:bottom-0 lg:gap-16 lg:pb-24">
