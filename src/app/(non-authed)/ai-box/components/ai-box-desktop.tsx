...
const AiBoxDesktop = () => {
  ...
  const [selectedSection, setSelectedSection] = useState("daily"); // New state for selected section
  ...
  return (
    <div className="relative flex w-full p-6">
      <div className="mx-auto max-w-screen-xl	 flex-grow rounded-xl p-8 backdrop-blur-xl">
          ...
          <div className="relative h-full">
            ...
            <div className="relative z-10  rounded-xl bg-gray-900/80 p-8 backdrop-blur-xl">
              ...
              <div className="relative mb-8 flex flex-wrap items-center justify-between space-y-2 md:space-y-0">
                ...
                {/* Main Header */}
                <h1
                  className="w-full text-center text-4xl font-bold tracking-wider text-red-400 md:w-auto"
                  style={jibril.style}
                >
                  AI CHALLENGE BOX
                </h1>
              ...
              <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
                ...
                <div className="space-y-6">
                  <div className="rounded-lg bg-gray-800/50 p-6">
                    ...
                    <p className="mb-4 space-y-3 text-xl text-gray-300">
                                  ...
                                  <span className="text-red-400">
                                    ...
                                    <a
                                      href={`${chainService.getExplorerUrl(
                                        data.transactions[0].chain,
                                      )}${data.aiJudgeQueryTxHash}#eventlog`}
                                      target="_blank"
                                      rel="noopener noreferrer"
                                      className="underline hover:underline"
                                    >
                        ...
                        <div className=" flex w-full items-center justify-between">
                          ...
                          {data.rating === 0 ? (
                            <Button
                              ...
                              onClick={() =>
                                handleCasualBoxSubmitPrompt(data.aiBoxId, playerPrompt)
                              }
                            >
        ...
        {selectedSection === "create" && <h2>Create Box Content</h2>}
        {selectedSection === "my" && <h2>My Boxes Content</h2>}
      </div>
